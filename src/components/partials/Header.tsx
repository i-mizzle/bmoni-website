...
const Header = () => {
  return (
    <header className='flex items-center justify-between px-[64px] py-[44px] mt-[32px] bg-transparent absolute top-0 left-0 w-full z-50'>
        <div className='flex items-center gap-x-[80px] w-1/2'>
            <Link href={`/`}>
        ...
        <div className='flex flex-row-reverse items-center gap-x-[20px] w-1/2'>
            <DownloadButton />
